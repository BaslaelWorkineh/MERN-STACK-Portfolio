...
class Node {
    ...
    *_getCompilerDescendantsOfKindIterator(kind) {
    ...
    static isJSDocThrowsTag(node) {
        return (node === null || node === void 0 ? void 0 : node.getKind()) === common.SyntaxKind.JSDocThrowsTag;
    }
...
class JsxAttribute extends JsxAttributeBase {
    getInitializerOrThrow(message) {
        return common.errors.throwIfNullOrUndefined(this.getInitializer(), message !== null && message !== void 0 ? message : `Expected to find an initializer for the JSX attribute '${this.getName()}'`, this);
    }
    getInitializer() {
        return this._getNodeFromCompilerNodeIfExists(this.compilerNode.initializer);
    }
