...
const serviceData = [
    {
      ...
      image: web,
      description:
        'I create custom digital solutions tailored to your business needs. From sleek designs to robust functionality, we leverage the latest technologies to ensure seamless user experiences across all platforms. Partner with me to elevate your online presence and stay ahead in the digital landscape.',
    },
    {
      title: 'Mobile App Development',
      image: phone,
      description:
        'I provide innovative and user-friendly applications to help businesses thrive in the mobile market. We utilize cutting-edge technologies to deliver high-quality, customized solutions that meet your unique needs and exceed expectations. Partner with me to bring your app ideas to life.',
    },
    {
      title: 'Debugging',
      image: debug,
      description:
        'In my Debugging service, I expertly identify and resolve software code issues to ensure seamless functionality. With a focus on efficiency and precision, I diagnose bugs of any complexity level, ensuring robust and error-free applications. Partner with me to for quality projects.',
    },
    {
      title: 'Mentorship',
      image: mentor,
      description:
        'Providing personalized guidance to help individuals navigate their professional and personal growth. Through tailored sessions and resources, as an experienced mentor, I empower mentees to achieve their goals, overcome challenges, and unlock their full potential. Join me now.',
    },
    {
      title: 'Game Development',
      image: game,
      description:
        'As the sole developer, my Game Development service is dedicated to bringing your unique vision to life. From conceptualization to execution, I specialize in crafting captivating games across different platforms. Partner with me to transform your gaming ideas into reality.',
    },
    {
      title: 'Low Poly 3D Design',
      image: skill1,
      description:
        'In my Low Poly 3D Design service, I specialize in creating visually stunning designs with a minimalist aesthetic. Using optimized techniques, I craft captivating scenes ideal for games, animations, and virtual environments. Partner with me to bring your creative visions to life.',
    },
  ];
...
const Home = () => {
    ...
    return (
        <>
            ...
            <section className='test'>
                ...
                <div className='box-container'>
                    <div className='box' style={{ background: theme === 'Light' ? '#f9f9f97b' : '#333',borderColor: theme === 'Light' ? '#333' : '#f9f9f97b' }}>
      ...
      {serviceData.map((service, index) => (
        <div
          key={index}
          className='ourServicesBox'
          style={{ borderColor: theme === 'Light' ? '#333' : '#f9f9f97b' }}
        >
          <img src={service.image} alt={service.title} />
          <h2 style={{ color: theme === 'Light' ? '#333' : '#dfdfdf' }}>
            {service.title}
          </h2>
          <p style={{ color: theme === 'Light' ? '#333' : '#bababa' }}>
            {service.description}
          </p>
        </div>
      ))}
